...
class Ui_detectWidget(object):
    def __init__(self):
        ...
        self.start_detection_button = None
    ...
    def _create_widgets(self, detectWidget):
        ...
        # Create Buttons
        self.select_video_button = QPushButton(self.horizontal_frame)
        self.select_video_button.setObjectName("selectVideoButton")
        self.start_detection_button = QPushButton(self.horizontal_frame)
        self.start_detection_button.setObjectName("startDetectionButton")
    ...
    def retranslate_ui(self, detectWidget):
        ...
        self.select_video_button.setText(
            QCoreApplication.translate("detectWidget", "Select Video", None)
        )
        self.start_detection_button.setText(
            QCoreApplication.translate("detectWidget", "Start", None)
        )
